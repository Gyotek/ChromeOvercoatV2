...
namespace Chrome
{
    ...
    #pragma warning disable 649
        ...
        private AudioClip walkingSound = default;

        [Tooltip("The audio clip that is played while running."), SerializeField]
        private AudioClip runningSound = default;

        [SerializeField]
        private CharacterDatas characterDatas = default;
    ...
    #pragma warning restore 649
        ...
        {
            characterDatas.minVerticalAngle = ClampRotationRestriction(characterDatas.minVerticalAngle, -90, 90);
            characterDatas.maxVerticalAngle = ClampRotationRestriction(characterDatas.maxVerticalAngle, -90, 90);
            if (characterDatas.maxVerticalAngle >= characterDatas.minVerticalAngle) return;
            Debug.LogWarning("maxVerticalAngle should be greater than minVerticalAngle.");
            var min = characterDatas.minVerticalAngle;
            characterDatas.minVerticalAngle = characterDatas.maxVerticalAngle;
            characterDatas.maxVerticalAngle = min;
        }
        ...
        {
            var rotationX = _rotationX.Update(RotationXRaw, characterDatas.rotationSmoothness);
            var rotationY = _rotationY.Update(RotationYRaw, characterDatas.rotationSmoothness);
        ...
        {
            get { return input.RotateX * characterDatas.mouseSensitivity; }
        }

        /// Returns the target rotation of the camera around the x axis with no smoothing.
        private float RotationYRaw
        {
            get { return input.RotateY * characterDatas.mouseSensitivity; }
        }
        ...
        private float RestrictVerticalRotation(float mouseY)
        {
            ...
            var minY = characterDatas.minVerticalAngle + currentAngle;
            var maxY = characterDatas.maxVerticalAngle + currentAngle;
        ...
        private void MoveCharacter()
        {
            ...
            var smoothX = _velocityX.Update(velocity.x, characterDatas.movementSmoothness);
